...
class DecompensationReader(Reader):
    ...
    def read_example(self, index):
        ...
        # (x, y, los, age, gender, ethnicity)
        y = self._data[index][2]
        los = self._data[index][3]
        age = self._data[index][4]
        gender = self._data[index][5]
        ethnicity = self._data[index][6]
...
class InHospitalMortalityReader(Reader):
    def __init__(self, dataset_dir, listfile=None, period_length=24.0):
        ...
        self._data = [line.split(",") for line in self._data]
        self._data = [
            (x, int(y), float(los), float(age), float(sex), (eth))
            for (x, y, los, age, sex, eth) in self._data
        ]
    ...
    def read_example(self, index):
        ...
        y_m = self._data[index][1]
        los = self._data[index][2]
        age = self._data[index][3]
        gender = self._data[index][4]
        ethnicity = self._data[index][5]
